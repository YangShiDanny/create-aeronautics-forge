package dev.ryanhcode.sable.forge.mixin.compatibility.create.display_link;
...
public class ClickToLinkBlockItemMixin {
    ...
    @WrapOperation(method = "m_6225_(Lnet/minecraft/world/item/context/UseOnContext;)Lnet/minecraft/world/InteractionResult;", at = @At(value = "INVOKE", target = "Lnet/minecraft/core/BlockPos;m_123314_(Lnet/minecraft/core/Vec3i;D)Z", remap = false))
