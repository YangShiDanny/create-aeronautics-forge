...
public class ModulatingLinkedReceiverScreen extends AbstractSimiScreen {
    ...
    protected void send() {
        dev.simulated_team.simulated.network.SimPacketManager.INSTANCE.server().sendPacket(new ConfigureModulatingLinkedRecieverPacket(this.be.getBlockPos(), this.minScroll.getState(), this.maxScroll.getState()));
    }
