package dev.ryanhcode.sable.forge.mixinhelper.compatibility.create.raycasts;
...
public class SableRaycastHelper {
    ...
    public static  RaycastHelper.PredicateTraceResult rayCastUntilWithSublevels(final Level level, final Vec3 start, final Vec3 end, final BiPredicate< SubLevel, BlockPos> predicate) {
