...
import dev.ryanhcode.sable.forge.mixin.compatibility.flywheel.LightStorageAccessor;
...
public class SableFlywheelLightStorage extends LightStorage {
    ...
    // flywheel 的父类 LightStorage.level 是 private，无法访问；此处自留一份同名字段遮蔽父类字段，指向同一 level 对象
