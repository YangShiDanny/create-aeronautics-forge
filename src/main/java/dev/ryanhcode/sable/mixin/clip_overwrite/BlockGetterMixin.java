...
public interface BlockGetterMixin {
    ...
    default BlockHitResult clip(ClipContext clipContext) {
        ...
        if (fromSubLevel != null) {
            ...
            clipContext = new ClipContext(JOMLConversion.toMojang(from), clipContext.getTo(), clipContext.block, clipContext.fluid, null);
        }
        ...
        if (toSubLevel != null) {
            ...
            clipContext = new ClipContext(clipContext.getFrom(), JOMLConversion.toMojang(to), clipContext.block, clipContext.fluid, null);
        }
        ...
        for (final SubLevel subLevel : subLevels) {
            ...
            final ClipContext subClipContext = new ClipContext(JOMLConversion.toMojang(from), JOMLConversion.toMojang(to), clipContext.block, clipContext.fluid, null);
    ...
    @Unique
    public default  BlockHitResult originalClip(final BlockGetter level, final ClipContext clipContext) {
