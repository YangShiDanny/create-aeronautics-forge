...
public class CFluidType {
    ...
    public CFluidType(final ResourceLocation type,  final DataComponentMap data) {
        this.fluid = BuiltInRegistries.FLUID.get(type);
        this.data = data;
    }

    public CFluidType(final Fluid type,  final DataComponentMap data) {
        this.fluid = type;
        this.data = data;
    }
    ...
    public static CFluidType read(final CompoundTag tag) {
        ...
        return new CFluidType(new ResourceLocation(tag.getString("Fluid")), map);
    }
