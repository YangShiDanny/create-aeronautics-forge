...
public class SubLevelArgumentType implements ArgumentType<SubLevelSelector> {
    ...
    private static  List<Pair<SubLevelSelectorModifierType, SubLevelSelectorModifierType.Modifier>> parseSelectorArguments(final StringReader reader) throws CommandSyntaxException {
        ...
        final List<Pair<String,  Message>> permittedPreEntryToken = new ArrayList<>(SubLevelSelectorModifierType.getAllNamesWithTooltip()
    ...
    @SafeVarargs
    public static void setSuggestionsWithTooltip(final StringReader reader, final Pair<String,  Message>... suggested) {
        setSuggestionsWithTooltip(reader, Arrays.asList(suggested));
    }

    public static void setSuggestionsWithTooltip(final StringReader reader, final List<Pair<String,  Message>> suggested) {
        final int cursor = reader.getCursor();
        suggestions = builder -> {
            final SuggestionsBuilder nextSuggestion = builder.createOffset(cursor);
            for (final Pair<String,  Message> suggestion : suggested) {
    ...
    public SubLevelSelector parse(final StringReader reader) throws CommandSyntaxException {
        final ObjectList<Pair<String,  Message>> allowedSelectors = new ObjectArrayList<>();
