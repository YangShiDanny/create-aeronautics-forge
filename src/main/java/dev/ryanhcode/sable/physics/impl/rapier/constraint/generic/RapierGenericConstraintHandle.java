...
public class RapierGenericConstraintHandle extends RapierConstraintHandle implements GenericConstraintHandle {
    ...
    public static  RapierGenericConstraintHandle create(final ServerLevel serverLevel,  final PhysicsPipelineBody bodyA,  final PhysicsPipelineBody bodyB, final GenericConstraintConfiguration config) {
