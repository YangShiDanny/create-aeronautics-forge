...
public class SimulatedClient {
    ...
    public static void init() {
        ...
        // [1.20.1 port] EndSea shadow/fade disabled (end_sea excluded)
        ...
        SuperByteBufferCache.getInstance().registerCompartment(PhysicsAssemblerRenderer.ASSEMBLER_LEVER_BUFFER);
    }
}
