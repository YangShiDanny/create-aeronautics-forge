...
public class OrientedBoundingBox3d {
     ...
     */
    public OrientedBoundingBox3d( final LevelReusedVectors sink) {
        this.sink = sink;
    }
     ...
     */
    public OrientedBoundingBox3d( final Vector3dc position,
                                  final Vector3dc dimensions,
     ...
     */
    public Vector3d  [] vertices(final Vector3d[] result) {
     ...
     */
    public Vector3d rotate( final Vector3d vec) {
     ...
     */
    private static boolean doesOverlap( final Vector2d a,  final Vector2d b) {
     ...
     */
    public static double getOverlap( final Vector2d a,  final Vector2d b) {
     ...
     */
    public static  Vector3d sat( final OrientedBoundingBox3d obbA,  final OrientedBoundingBox3d obbB) {
     ...
     * Computes the MTV, or Minimum Translation Vector between the vertices of two OBBs.
     */
    public static  Vector3d sat( final OrientedBoundingBox3d obbA,  final OrientedBoundingBox3d obbB,  final Vector3d dest) {
     ...
     */
    public static  Vector2d checkSeparation(final Vector3d  [] self,  final Vector3d axis, final Vector2d result) {
