...
public record TypewriterKeySavePacket(Map<Integer, LinkedTypewriterEntries.KeyboardEntry> changedKeys, BlockPos pos,
    ...
    public static final StreamCodec<ByteBuf, TypewriterKeySavePacket> CODEC = StreamCodec.composite(
            ...
            BackportCodecs.BLOCK_POS, TypewriterKeySavePacket::pos,
    ...
    public void handle(final ServerPacketContext context) {
        ...
        if (be instanceof final LinkedTypewriterBlockEntity lbe) {
            ...
            if (lbe.getTypewriterEntries().getSize() >= 26) {
                SimAdvancements.I_PAID_FOR_THE_WHOLE_TYPEWRITER.awardTo(context.getPlayer());
            }
