...
public class PropellerParticleSpawningInstruction extends TickingInstruction {
	...
	public PropellerParticleSpawningInstruction( final ElementLink<WorldSectionElement> link, final BlockPos location, final Direction direction, final int ticks, final float particleAmount, final float particleSpeed, final float radius) {
		this(link, location, direction, ticks, particleAmount, particleSpeed, radius, false);
	}

	public PropellerParticleSpawningInstruction( final ElementLink<WorldSectionElement> link, final BlockPos location, final Direction direction, final int ticks, final float particleAmount, final float particleSpeed, final float radius, final boolean hasCollision) {
		super(false, ticks);
	...
	public static class ParticleSpawner
	{
		...
		ParticleSpawner( final ElementLink<WorldSectionElement> link, final BlockPos location, final Direction direction, final float particleAmount, final float particleSpeed, final float radius, final boolean hasCollision) {
			this.link = link;
