...
public class FancySubLevelOcclusionData {
    ...
    public void update(final int sectionX, final int sectionY, final int sectionZ, final boolean smartCull, final Frustum cullFrustum) {
        try {
...
//            }
            ...
            for (final FancySubLevelSectionCompiler.RenderSection section : this.renderSections) {
                ...
                if (cullFrustum.isVisible(new AABB(pos.x - 14, pos.y - 14, pos.z - 14, pos.x + 14, pos.y + 14, pos.z + 14))) {
