...
public class CombatTrackerMixin {
    ...
    @WrapOperation(method = "m_289215_", remap = false, at = @At(value = "INVOKE", target = "Lnet/minecraft/network/chat/Component;m_237110_(Ljava/lang/String;[Ljava/lang/Object;)Lnet/minecraft/network/chat/MutableComponent;", remap = false))
