package dev.ryanhcode.sable.forge.mixin.compatibility.create.block_breakers;
...
public class BlockBreakingKineticBlockEntityDamageMixin {
	...
	@WrapOperation(method = "m_7892_(Lnet/minecraft/world/level/block/state/BlockState;Lnet/minecraft/world/level/Level;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/entity/Entity;)V", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/phys/AABB;m_82381_(Lnet/minecraft/world/phys/AABB;)Z", remap = false))
