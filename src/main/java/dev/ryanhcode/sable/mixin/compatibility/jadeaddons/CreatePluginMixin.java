...
public class CreatePluginMixin {
	...
	@WrapOperation(method = "lambda$registerClient$1", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/Entity;m_20299_(F)Lnet/minecraft/world/phys/Vec3;", remap = false))
	...
	@WrapOperation(method = "lambda$registerClient$1", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/Entity;m_20252_(F)Lnet/minecraft/world/phys/Vec3;", remap = false))
