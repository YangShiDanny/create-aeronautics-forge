...
public class RapierRotaryConstraintHandle extends RapierConstraintHandle implements RotaryConstraintHandle {
     ...
     */
    public static RapierRotaryConstraintHandle create(final ServerLevel serverLevel,  final PhysicsPipelineBody bodyA,  final PhysicsPipelineBody bodyB, final RotaryConstraintConfiguration config) {
