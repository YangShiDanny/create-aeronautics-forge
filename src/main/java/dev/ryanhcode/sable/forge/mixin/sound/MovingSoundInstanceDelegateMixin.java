package dev.ryanhcode.sable.forge.mixin.sound;
...
public abstract class MovingSoundInstanceDelegateMixin implements SoundInstance {
    ...
    @Override
    public  CompletableFuture<AudioStream> getStream(final SoundBufferLibrary soundBuffers, final Sound sound, final boolean looping) {
