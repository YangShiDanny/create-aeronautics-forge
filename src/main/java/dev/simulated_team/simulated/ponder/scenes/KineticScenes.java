...
public class KineticScenes {
    ...
    public static void steeringWheelComparator(final SceneBuilder builder, final SceneBuildingUtil util) {
        ...
        final ElementLink<ParrotElement> birb = scene.special().createBirb(net.minecraft.world.phys.Vec3.atBottomCenterOf(steeringWheelPos.north()).subtract(0, 2, 0.25), ParrotPose.FacePointOfInterestPose::new);
