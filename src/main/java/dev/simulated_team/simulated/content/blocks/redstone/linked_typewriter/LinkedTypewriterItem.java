...
public class LinkedTypewriterItem extends BlockItem {
    ...
    @Override
    public void appendHoverText(final ItemStack stack, final Level level, final List<Component> tooltipComponents, final TooltipFlag tooltipFlag) {
        super.appendHoverText(stack, level, tooltipComponents, tooltipFlag);
        if (DataComponentType.has(stack, DataComponents.BLOCK_ENTITY_DATA)) {
            final CompoundTag tag = DataComponentType.get(stack, DataComponents.BLOCK_ENTITY_DATA).copyTag();
