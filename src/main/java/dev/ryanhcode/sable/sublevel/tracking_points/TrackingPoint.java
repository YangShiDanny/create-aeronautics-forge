 ...
 */
public record TrackingPoint(boolean inSubLevel,  UUID subLevelID,  GlobalSavedSubLevelPointer lastSavedSubLevelPointer, Vector3d point, Vector3d globalPlaceholderPosition) {
}
