...
public class AeroPacketManager {
	...
	public static void init() {
		INSTANCE.registerServerbound(LevititeCatalystCrystallizationPacket.class, LevititeCatalystCrystallizationPacket.TYPE, LevititeCatalystCrystallizationPacket.STREAM_CODEC, LevititeCatalystCrystallizationPacket::handle);
	}
}
