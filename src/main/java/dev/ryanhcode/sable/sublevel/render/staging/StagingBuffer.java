    ...
    public static StagingBuffer create(final long size) {
        if (stagingBufferType == null) {
            ...
            if (caps.OpenGL44 || caps.GL_ARB_buffer_storage) {
                // Forge 1.20.1: native LWJGL capability check in place of
                // VeilRenderSystem.directStateAccessSupported().
                stagingBufferType = caps.GL_ARB_direct_state_access ? StagingBufferType.DSA : StagingBufferType.ARB;
            } else {
