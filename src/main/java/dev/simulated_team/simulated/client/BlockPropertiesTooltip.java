...
public class BlockPropertiesTooltip {
    ...
    private static final Component SUPER_HEAVY = Component.translatable("simulated.tooltip.mass.super_heavy").withStyle(net.minecraft.network.chat.Style.EMPTY.withColor(SimColors.NUH_UH_RED));
    private static final Component ABSURDLY_HEAVY = Component.translatable("simulated.tooltip.mass.absurdly_heavy").withStyle(net.minecraft.network.chat.Style.EMPTY.withColor(SimColors.NUH_UH_RED));
    ...
    private static final Component FRAGILE = Component.translatable("simulated.tooltip.fragile").withStyle(net.minecraft.network.chat.Style.EMPTY.withColor(SimColors.NUH_UH_RED));
    ...
    public static boolean shouldShowTooltip(final Condition condition, final TooltipFlag iTooltipFlag, final  Player player) {
    ...
    public static  Component getRestitutionComponent(final BlockStateExtension properties, final BlockItem item, final boolean showNumbers) {
    ...
    public static  Component getFrictionComponent(final BlockStateExtension properties, final BlockItem item, final boolean showNumbers) {
    ...
    public static  Component getFragileComponent(final BlockStateExtension properties, final BlockItem item, final boolean showNumbers) {
    ...
    public static  Component getAirtightComponent(final BlockStateExtension properties, final BlockItem item, final boolean showNumbers) {
    ...
    public static  Component getFloatingComponent(final BlockStateExtension properties, final BlockItem item, final boolean showNumbers) {
    ...
    public record Entry(TooltipFunction tooltipFunction, float priority) implements Comparable<Entry> {
        @Override
        public int compareTo( final BlockPropertiesTooltip.Entry o) {
