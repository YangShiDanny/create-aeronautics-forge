...
public class PlayerListMixin {
     ...
     */
    @Overwrite
    public void broadcast( final Player player, final double x, final double y, final double z, final double maxDistance, final ResourceKey<Level> resourceKey, final Packet<?> packet) {
