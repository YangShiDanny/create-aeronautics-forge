...
public class LevititeBlendTicker {
	 ...
	 */
	public LevititeBlendTicker(final int age,  final BlockPos pos,  final Level level, final boolean requiresCatalyst, final boolean isDormant,  final CrystalPropagationContext context) {
		this.age = age;
		this.pos = pos;
		this.level = level;
