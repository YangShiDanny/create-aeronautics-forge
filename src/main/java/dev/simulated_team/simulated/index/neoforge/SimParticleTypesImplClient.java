...
// SimParticleTypes.registerClientParticles 内部经由 lambda 引用客户端类
// RegisterParticleProvidersEvent / ParticleEngine；若放在主类 register 内，
...
@OnlyIn(Dist.CLIENT)
public final class SimParticleTypesImplClient {
    private SimParticleTypesImplClient() {}

    public static void register(final IEventBus modEventBus) {
        modEventBus.addListener(SimParticleTypesImplClient::registerParticleProviders);
    }
