...
public class SableSubLevelCommands {
    ...
    private static int setSubLevelNames(final Collection<ServerSubLevel> subLevels,  final String name) {
        int modifiedCount = 0;
    ...
    private static int executeTeleportSubLevelCommand(final CommandContext<CommandSourceStack> ctx, final  Coordinates angle) throws CommandSyntaxException {
