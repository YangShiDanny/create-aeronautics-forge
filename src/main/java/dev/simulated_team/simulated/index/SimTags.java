...
public class SimTags {
    ...
    public static class Items {
        public static final TagKey<Item> STONE = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "stones"));
        public static final TagKey<Item> REDSTONE_DUST = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "dusts/redstone"));
        public static final TagKey<Item> SLIME_BALLS = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "slime_balls"));
        public static final TagKey<Item> AMETHYST_SHARDS = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "gems/amethyst"));
    ...
    static {
        for (final DyeColor color : DyeColor.values()) {
            DYE_MAP.put(color.getName(), AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "dyes/" + color.getName())));
        }
    }
