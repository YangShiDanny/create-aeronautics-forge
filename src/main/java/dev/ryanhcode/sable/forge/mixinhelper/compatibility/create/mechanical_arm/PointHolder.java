package dev.ryanhcode.sable.forge.mixinhelper.compatibility.create.mechanical_arm;
...
public record PointHolder(BlockPos pos, ArmInteractionPoint.Mode interactionMode, MutableBoolean covered) {
    ...
    public static PointHolder deserialize(final CompoundTag tag, final BlockPos anchor) {
        ...
        return new PointHolder(pos.offset(anchor), NBTHelper.readEnum(tag, "mode", ArmInteractionPoint.Mode.class), new MutableBoolean(false));
