...
public class PonderUIMixin {
    ...
    @ModifyConstant(remap = false, method = "renderScene", constant = @Constant(intValue = 0x66_000000, ordinal = 0))
    ...
    @Inject(remap = false, method = "renderScene", at = @At(value = "INVOKE", target = "Lcom/mojang/blaze3d/vertex/PoseStack;m_252880_(FFF)V", ordinal = 1, shift = At.Shift.AFTER))
