...
public class LinkedTypewriterEntries {
    ...
    public static LinkedTypewriterEntries readKeys(final HolderLookup.Provider registryAccess, final ListTag tags, final BlockPos pos) {
        ...
        for (final Tag tag : tags) {
            final RegistryOps<Tag> ops = RegistryOps.create(NbtOps.INSTANCE, registryAccess);
     ...
     */
    public void setKey(final int index,  final LinkedTypewriterEntries.KeyboardEntry keyboardEntry) {
    ...
    public static class KeyboardEntry implements IRedstoneLinkable {
        ...
        public static final StreamCodec<ByteBuf, KeyboardEntry> STREAM_CODEC = StreamCodec.composite(
                ByteBufCodecs.OPTIONAL_ITEM, KeyboardEntry::getFirstAsItemStack,
                ByteBufCodecs.OPTIONAL_ITEM, KeyboardEntry::getSecondAsItemStack,
        ...
        private static  Item mapOptional(final Optional<Item> optional) {
