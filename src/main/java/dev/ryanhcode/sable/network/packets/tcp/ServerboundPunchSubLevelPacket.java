...
public record ServerboundPunchSubLevelPacket(BlockPos punchedBlock, Vector3dc localPosition,
    ...
    public static void encode(final FriendlyByteBuf buf, final ServerboundPunchSubLevelPacket msg) {
        msg.write(buf);
    }

    public static ServerboundPunchSubLevelPacket decode(final FriendlyByteBuf buf) {
        return ServerboundPunchSubLevelPacket.read(buf);
    }
