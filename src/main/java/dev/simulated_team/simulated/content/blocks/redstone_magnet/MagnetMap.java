...
public class MagnetMap<T extends BlockEntity & SimMagnet> {
     ...
     */
    public  MagnetPair<T> tryAddPair(final Level level, final BlockPos pos1, final BlockPos pos2, final MagnetConsumer<T> consumer) {
    ...
    public  MagnetPair<T> getPair(final Level level, final BlockPos pos1, final BlockPos pos2) {
        final Map<MagnetPairIdentifier, MagnetPair<T>> levelMap = this.pairMap.get(level);
        if (levelMap == null) {
            return null;
        }
