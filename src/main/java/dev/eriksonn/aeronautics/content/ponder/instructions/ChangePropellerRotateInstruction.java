...
public abstract class ChangePropellerRotateInstruction extends PonderInstruction {
    ...
    public static class SetParticles extends ChangePropellerRotateInstruction {
        public SetParticles(PropellerRotateInstruction instruction,  final ElementLink<WorldSectionElement> link, final float particleAmount, final float particleSpeed, final float radius, final boolean hasCollision) {
            super(instruction, (i,s) -> {
        ...
        public SetParticles(PropellerRotateInstruction instruction,BlockPos location,  final ElementLink<WorldSectionElement> link, final float particleAmount, final float particleSpeed, final float radius, final boolean hasCollision) {
            super(instruction, (i,s) -> {
                i.particleSpeedScale = particleSpeed;
                i.particleAmountScale = particleAmount;
