...
public interface PhysicsPipeline {
     ...
     */
    default void onStatsChanged( final ServerSubLevel serverSubLevel) {
    ...
    default <T extends PhysicsConstraintHandle> T addConstraint( final PhysicsPipelineBody bodyA,  final PhysicsPipelineBody bodyB,  final PhysicsConstraintConfiguration<T> configuration) {
