...
public class CameraTypeMixin {
    ...
    public CameraType cycle() {
        final CameraType result;
        if ((Object) this == SableCameraTypes.SUB_LEVEL_VIEW) {
            result = SableCameraTypes.SUB_LEVEL_VIEW_UNLOCKED;
        } else if ((Object) this == SableCameraTypes.SUB_LEVEL_VIEW_UNLOCKED) {
            result = CameraType.THIRD_PERSON_FRONT;
        } else {
            result = switch ((CameraType) (Object) this) {
