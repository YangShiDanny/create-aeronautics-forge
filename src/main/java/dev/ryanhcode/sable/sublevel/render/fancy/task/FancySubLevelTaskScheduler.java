...
public class FancySubLevelTaskScheduler {
    ...
    public void schedule(final SubLevelTask task, final double distance,  final Runnable onComplete) {
        if (!this.running.get()) {
    ...
    public void scheduleCompile(final FancySubLevelSectionCompiler.RenderSection section,  final RenderChunkRegion renderChunkRegion, final double distance,  final Consumer<FancySubLevelSectionCompiler.RenderSection> onComplete) {
    ...
    private record Task(SubLevelTask task, double distance,  Runnable onComplete) implements Comparable<Task> {

        @Override
        public int compareTo( final FancySubLevelTaskScheduler.Task o) {
