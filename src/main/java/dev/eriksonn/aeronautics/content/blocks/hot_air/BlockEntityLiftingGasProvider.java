...
public interface BlockEntityLiftingGasProvider {
    ...
    // [reobf 兜底] 同 BlockEntityPropeller：生产环境继承的原版方法被改成 SRG 名，改 default + 强转。
    default BlockPos getBlockPos() {
        if (this instanceof net.minecraft.world.level.block.entity.BlockEntity be) {
            return be.getBlockPos();
        }
        throw new IllegalStateException("BlockEntityLiftingGasProvider implementor must override getBlockPos(): " + this.getClass());
    }
    ...
    default Level getLevel() {
        ...
        throw new IllegalStateException("BlockEntityLiftingGasProvider implementor must override getLevel(): " + this.getClass());
    }
