...
public final class DefaultSableCompanion implements SableCompanion {
    ...
    @Override
    public  SubLevelAccess getContaining(final Level level, final int chunkX, final int chunkZ) {
        return null;
    }
    ...
    @Override
    public  SubLevelAccess getTrackingSubLevel(final Entity entity) {
        return null;
    }

    @Override
    public  SubLevelAccess getLastTrackingSubLevel(final Entity entity) {
        return null;
    }

    @Override
    public  SubLevelAccess getTrackingOrVehicleSubLevel(final Entity entity) {
        return null;
    }

    @Override
    public  SubLevelAccess getVehicleSubLevel(final Entity entity) {
        return null;
    }
