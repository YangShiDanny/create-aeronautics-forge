...
public class AugerIndicatorParticleData implements ParticleOptions, ICustomParticleDataWithSprite<AugerIndicatorParticleData> {
    ...
    public Codec<AugerIndicatorParticleData> getCodec(final ParticleType<AugerIndicatorParticleData> type) {
        ...
        public StreamCodec<? super FriendlyByteBuf, AugerIndicatorParticleData> getStreamCodec() {
        return STREAM_CODEC;
    }
    ...
    public ParticleOptions.Deserializer<AugerIndicatorParticleData> getDeserializer() {
        return new ParticleOptions.Deserializer<>() {
            @Override
            public AugerIndicatorParticleData fromNetwork(final ParticleType<AugerIndicatorParticleData> type, final FriendlyByteBuf buf) {
                return getStreamCodec().decode(buf);
            }
            @Override
            public AugerIndicatorParticleData fromCommand(final ParticleType<AugerIndicatorParticleData> type, final StringReader reader) {
