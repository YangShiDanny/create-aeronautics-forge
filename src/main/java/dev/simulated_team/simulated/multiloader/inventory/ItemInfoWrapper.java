...
public record ItemInfoWrapper(Item type, DataComponentPatch patchMap) {
    ...
    public static ItemInfoWrapper generateFromStack(final ItemStack stack) {
        return new ItemInfoWrapper(stack.getItem(), DataComponentType.getComponentsPatch(stack));
    }
     ...
     */
    public static  ItemStack generateFromInfo(final ItemInfoWrapper info) {
        ...
        DataComponentType.applyComponents(newStack, builder.build());
        return newStack;
    }
