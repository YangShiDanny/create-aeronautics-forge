...
public class EntryModifierScreen {
    ...
    public PsuedoKeyboardEntry startModifying( final LinkedTypewriterEntries.KeyboardEntry toModify, final Consumer<LinkedTypewriterEntries.KeyboardEntry> onFinish) {
        ...
        dev.simulated_team.simulated.network.SimPacketManager.INSTANCE.server().sendPacket(new TypewriterMenuModifySlots(first, second));
    ...
    public void disable() {
        ...
        dev.simulated_team.simulated.network.SimPacketManager.INSTANCE.server().sendPacket(new TypewriterMenuModifySlots(ItemStack.EMPTY, ItemStack.EMPTY));
    }
