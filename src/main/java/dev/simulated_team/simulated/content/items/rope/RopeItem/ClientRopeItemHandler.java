...
public class ClientRopeItemHandler {
    ...
    public static void tick() {
        ...
        for (final InteractionHand hand : InteractionHand.values()) {
            ...
            if (!DataComponentType.has(heldItem, SimDataComponents.ROPE_FIRST_CONNECTION))
                continue;

            final BlockPos firstBlock = DataComponentType.get(heldItem, SimDataComponents.ROPE_FIRST_CONNECTION);
