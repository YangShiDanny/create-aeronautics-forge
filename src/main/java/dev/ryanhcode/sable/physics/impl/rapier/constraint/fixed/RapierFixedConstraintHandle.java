...
public class RapierFixedConstraintHandle extends RapierConstraintHandle implements FixedConstraintHandle {
     ...
     */
    public static RapierFixedConstraintHandle create(final ServerLevel serverLevel,  final PhysicsPipelineBody bodyA,  final PhysicsPipelineBody bodyB, final FixedConstraintConfiguration config) {
