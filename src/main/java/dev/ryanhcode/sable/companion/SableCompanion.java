...
public interface SableCompanion {
     ...
     */
    @Contract(pure = true)
     SubLevelAccess getContaining(final Level level, final int chunkX, final int chunkZ);
     ...
     */
    @Contract(pure = true)
    default  SubLevelAccess getContaining(final Level level, final ChunkPos chunkPos) {
     ...
     */
    @Contract(pure = true)
    default  SubLevelAccess getContaining(final Level level, final SectionPos pos) {
     ...
     */
    @Contract(pure = true)
    default  SubLevelAccess getContaining(final Level level, final Vec3i pos) {
     ...
     */
    @Contract(pure = true)
    default  SubLevelAccess getContaining(final Level level, final Position pos) {
     ...
     */
    @Contract(pure = true)
    default  SubLevelAccess getContaining(final Level level, final Vector3dc pos) {
        return this.getContaining(level, Mth.floor(pos.x()) >> SectionPos.SECTION_BITS, Mth.floor(pos.z()) >> SectionPos.SECTION_BITS);
    }
     ...
     */
    @Contract(pure = true)
    default  SubLevelAccess getContaining(final Level level, final double blockX, final double blockZ) {
     ...
     */
    @Contract(pure = true)
    default  SubLevelAccess getContaining(final Entity entity) {
     ...
     */
    @Contract(pure = true)
    default  SubLevelAccess getContaining(final BlockEntity blockEntity) {
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final int chunkX, final int chunkZ) {
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final ChunkPos chunkPos) {
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final Position pos) {
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final Vector3dc pos) {
        return (ClientSubLevelAccess) this.getContaining(this.getClientLevel(), pos);
    }
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final SectionPos pos) {
        return (ClientSubLevelAccess) this.getContaining(this.getClientLevel(), pos);
    }
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final Vec3i pos) {
        return (ClientSubLevelAccess) this.getContaining(this.getClientLevel(), pos);
    }
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final double blockX, final double blockZ) {
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final Entity entity) {
     ...
     */
    @Contract(pure = true)
    default  ClientSubLevelAccess getContainingClient(final BlockEntity blockEntity) {
    ...
    @Contract(pure = true)
    <T, S extends SubLevelAccess> T runIncludingSubLevels(final Level level, final Vec3 origin, final boolean shouldCheckOrigin,  final S subLevel, final BiFunction< S, BlockPos, T> converter);
    ...
    @Contract(pure = true)
    default <T, S extends SubLevelAccess> T runIncludingSubLevels(final Level level, final Position origin, final boolean shouldCheckOrigin,  final S subLevel, final BiFunction< S, BlockPos, T> converter) {
    ...
    @Deprecated
    @Contract(pure = true)
    <S extends SubLevelAccess> boolean findIncludingSubLevels(final Level level, final Vec3 origin, final boolean shouldCheckOrigin,  final S subLevel, final BiFunction< S, BlockPos, Boolean> converter);
     ...
     */
    @Contract(pure = true)
    default <S extends SubLevelAccess> boolean findIncludingSubLevels(final Level level, final Position origin, final boolean shouldCheckOrigin,  final S subLevel, final BiFunction< S, BlockPos, Boolean> converter) {
     ...
     */
    @Contract(pure = true)
     SubLevelAccess getTrackingSubLevel(final Entity entity);
     ...
     */
    @Contract(pure = true)
     SubLevelAccess getLastTrackingSubLevel(final Entity entity);
     ...
     */
    @Contract(pure = true)
     SubLevelAccess getTrackingOrVehicleSubLevel(final Entity entity);
     ...
     */
    @Contract(pure = true)
     SubLevelAccess getVehicleSubLevel(final Entity entity);
     ...
     */
    @Contract(pure = true)
    default Vector3d getFeetPos(final Entity entity, final float distanceDown,  final Quaterniondc orientation) {
