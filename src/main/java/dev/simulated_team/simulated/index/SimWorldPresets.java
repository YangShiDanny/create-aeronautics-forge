...
public class SimWorldPresets {
	...
	private static <T extends SimulatedWorldPreset> T create(final BiFunction<ResourceLocation, Component, T> constructor, final String name,  final Component description) {
