...
public class ConfirmationWidgetBase extends IconButton {
    ...
    public void renderHoveredText(final GuiGraphics graphics, final int mouseX, final int mouseY) {
        graphics.renderComponentTooltip(Minecraft.getInstance().font, java.util.Collections.singletonList(this.message.withStyle(net.minecraft.network.chat.Style.EMPTY.withColor(0xff0000))), mouseX, mouseY);
    }
