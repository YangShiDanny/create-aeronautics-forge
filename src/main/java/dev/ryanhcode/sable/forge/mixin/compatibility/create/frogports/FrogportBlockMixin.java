...
public class FrogportBlockMixin {
    @WrapOperation(method = "lambda$setPlacedBy$0", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/LivingEntity;m_20182_()Lnet/minecraft/world/phys/Vec3;", remap = false))
