...
public class AeroSoundDistUtil {
    public static  Object tickPropellerSounds(final PropellerBearingBlockEntity be,  Object soundInstance) {
        final SoundManager soundManager = Minecraft.getInstance().getSoundManager();
        boolean needsNewSounds = false;

        if (soundInstance instanceof PropellerBearingSoundHolder holder
