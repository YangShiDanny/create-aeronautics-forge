...
public class SimpleCulledRenderRegionBuilder {
    ...
    protected boolean shouldFaceRender( final Cube cube,  final Direction direction) {
        final int x0 = cube.x;
        final int y0 = cube.y;
        final int z0 = cube.z;
    ...
    public void render( final Matrix4f matrix4f,  final VertexConsumer consumer) {
        for (final Cube cube : this.cubes) {
            ...
            if (this.shouldFaceRender(cube, Direction.NORTH)) {
                consumer.vertex(matrix4f, (float)(x0), (float)(y0), (float)(z0)).endVertex();
                consumer.vertex(matrix4f, (float)(x0), (float)(y1), (float)(z0)).endVertex();
                consumer.vertex(matrix4f, (float)(x1), (float)(y1), (float)(z0)).endVertex();
                consumer.vertex(matrix4f, (float)(x1), (float)(y0), (float)(z0)).endVertex();
            }

            if (this.shouldFaceRender(cube, Direction.EAST)) {
                consumer.vertex(matrix4f, (float)(x1), (float)(y0), (float)(z0)).endVertex();
                consumer.vertex(matrix4f, (float)(x1), (float)(y1), (float)(z0)).endVertex();
                consumer.vertex(matrix4f, (float)(x1), (float)(y1), (float)(z1)).endVertex();
                consumer.vertex(matrix4f, (float)(x1), (float)(y0), (float)(z1)).endVertex();
            }

            if (this.shouldFaceRender(cube, Direction.SOUTH)) {
                consumer.vertex(matrix4f, (float)(x1), (float)(y0), (float)(z1)).endVertex();
                consumer.vertex(matrix4f, (float)(x1), (float)(y1), (float)(z1)).endVertex();
                consumer.vertex(matrix4f, (float)(x0), (float)(y1), (float)(z1)).endVertex();
                consumer.vertex(matrix4f, (float)(x0), (float)(y0), (float)(z1)).endVertex();
            }
