...
public abstract class CameraStandEntityMixin extends Entity {
	...
	@WrapOperation(method = "isInInteractionRange", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/LivingEntity;m_146892_()Lnet/minecraft/world/phys/Vec3;", remap = false))
