...
public class AeroTags {
	...
	public static class ItemTags {
		public static final TagKey<Item> LEATHERS = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "leathers"));
		public static final TagKey<Item> ARMORS = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "armors"));
		public static final TagKey<Item> HEAD_ARMOR = TagKey.create(Registries.ITEM, new ResourceLocation("minecraft", "head_armor"));
		public static final TagKey<Item> IRON_SHEET = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "plates/iron"));
		public static final TagKey<Item> GOLD_SHEET = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "plates/gold"));
		public static final TagKey<Item> MUSIC_DISCS = AllTags.optionalTag(net.minecraftforge.registries.ForgeRegistries.ITEMS, new net.minecraft.resources.ResourceLocation("c", "music_discs"));
